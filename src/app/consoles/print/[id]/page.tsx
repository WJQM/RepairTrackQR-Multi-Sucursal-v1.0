      ...
      {mode === "sticker" ? (() => {
        ...
        <div className="ficha-content" style={{ maxWidth: 820, margin: "0 auto", padding: "24px 20px" }}>
          <div className="ficha-page" style={{ background: "#fff", borderRadius: 10, border: "1px solid #e5e7eb", overflow: "hidden", boxShadow: "0 4px 16px rgba(0,0,0,0.06)" }}>
            ...
            <div className="ficha-grid" style={{ display: "grid", gridTemplateColumns: mainImg ? "340px 1fr" : "1fr", gap: 0, borderBottom: "1px solid #e5e7eb" }}>
              {mainImg && (
              ...
              <div className="ficha-main" style={{ padding: "20px 24px", display: "flex", flexDirection: "column", gap: 12 }}>
